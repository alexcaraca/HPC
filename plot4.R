...
par(mar= c(4,4,1,1), oma= c(0,1,1,1), mfrow = c(2,2))
# plot1
...
# plot2
plot(HPCfiltered$Time,HPCfiltered$Voltage,xaxt="n", 
...
# plot4
plot(HPCfiltered$Time,HPCfiltered$Global_reactive_power,xaxt="n", 
